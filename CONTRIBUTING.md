# Contributing to NEM Library

First off, thank you for considering contributing to NEM Library. 
It’s people like you that make NEM Library such a great tool.

NEM Library is an open source project and we love to receive contributions from 
...
writing code which can be incorporated into NEM Library itself.
...
You will need to fork the main NEM Library code or documentation repository and clone 
...
Then sit back and wait. There will probably be discussion about the pull request and, if any changes are needed, we would love to work with you to get your pull request merged into NEM Library.

## Contributing to the NEM Library codebase
...
[github-issues]: https://github.com/aleixmorgadas/nem-library-ts/issues